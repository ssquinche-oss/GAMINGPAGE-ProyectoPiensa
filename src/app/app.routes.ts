...
export const routes: Routes = [
  ...
  {
   path: 'instrucciones',
   loadComponent: () => import('./page/instrucciones/instrucciones.page').then(m => m.InstruccionesPage),
  },
  {
   path: 'descarga',
   loadComponent: () => import('./page/descarga/descarga.page').then(m => m.DescargaPage),
  },
];
